...
{
    /// <summary>
    /// Summary description for Sub Image
    /// </summary>
    public class Sub_Image : BaseFileUpload
    {
        public Sub_Image(RequestInfo request) : base(request)
        {
        ...
        protected override RequestResult ProcessRequest()
        {
            ...
            {
                case "IMAGE": return ProcessRequest_UploadSubImage();
                default: throw new System.Exception("Option not found.");

            }
        }

        protected RequestResult ProcessRequest_UploadSubImage()
        {
            int MAX_WIDTH = 1920;
            int MAX_HEIGHT = 1080;
